...
Revision ID: be44ce27104a
Revises: 
Create Date: 2024-07-30 15:45:01.434702
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_source_s3_id'), 'source_s3', ['id'], unique=False)
    ...
    op.create_table('item_s3',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('source_s3_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['source_s3_id'], ['source_s3.id'], name='item_s3_source_s3_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('tag_item_s3',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('tag_id', sa.Integer(), nullable=False),
    sa.Column('item_s3_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['item_s3_id'], ['item_s3.id'], name='tag_item_s3_item_s3_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['tag_id'], ['tag.id'], name='tag_item_s3_tag_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('tag_item_s3')
    op.drop_table('item_vimeo')
    op.drop_table('item_s3')
    ...
    op.drop_index(op.f('ix_source_s3_id'), table_name='source_s3')
    op.drop_table('source_s3')
